...
SELECT DISTINCT ON (v.id, 'city_sticker', vr.city_sticker_expiry)
  v.id as vehicle_id,
  v.user_id,
...
INSERT INTO obligations (vehicle_id, user_id, type, due_date, completed, created_at)
SELECT DISTINCT ON (v.id, 'license_plate', vr.license_plate_expiry)
  v.id as vehicle_id,
  v.user_id,
...
INSERT INTO obligations (vehicle_id, user_id, type, due_date, completed, created_at)
SELECT DISTINCT ON (v.id, 'emissions', vr.emissions_due_date)
  v.id as vehicle_id,
  v.user_id,
  'emissions' as type,
