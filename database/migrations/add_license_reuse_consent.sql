...
COMMENT ON COLUMN user_profiles.license_reuse_consent_given IS 'User consents to reusing their license image for multiple years of city sticker renewals';
