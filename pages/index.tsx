    ...
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{ marginTop: '12px', color: '#A7F3D0' }}>But 68.5% of contested parking tickets win.</div>
        </div>
        <p style={{
          margin: '24px 0 0',
          color: '#64748B',
