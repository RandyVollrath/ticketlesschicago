...
export default function OfferFlyer() {
  return (
    <FlyerLanding
      ...
      subhead="The average Chicago car owner pays $234 a year in avoidable tickets, tow fees, and impound charges. Autopilot is $99 — unlimited tickets, all year. Do the math."
      ...
      bullets={[
        'Every ticket auto-contested — 59% of mail-in contested Chicago parking tickets are dismissed (FOIA).',
