  ...
  return (
    <FlyerLanding
      ...
      bullets={[
        ...
        'If you get a ticket anyway, we detect it within 3 days and auto-contest — 59% of mail-in contested Chicago parking tickets are dismissed.',
        'Snow ban, metered parking, permit zone, and red-light/speed camera alerts — all included in the same $99/year.',
      ]}
    />
  );
}
