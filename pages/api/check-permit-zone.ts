...
export default async function handler(
  ...
  try {
    ...
    // Hours are deliberately not returned. Our residential permit-zone hours
    // dataset was gathered from Google Street View signs and is too uneven to
    // surface as authoritative — clients show a "may be active, check posted
    // signs" warning instead of specific times.
