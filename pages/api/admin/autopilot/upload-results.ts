...
function normalizeViolationType(input: string): string {
  ...
  const validTypes = ['expired_plates', 'no_city_sticker', 'expired_meter', 'disabled_zone',
                      'street_cleaning', 'fire_hydrant', 'speed_camera',
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="padding: 24px; background: white; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
        ...
        <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
          No evidence? No problem — we'll automatically contest on your behalf using automated evidence. But personal evidence significantly increases your chances, so reply as soon as you can.
        </p>
