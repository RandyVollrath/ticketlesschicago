    ...
    'drip-proof': {
      ...
      html: quickEmail({
        ...
        body: [
          ...
          callout('danger', 'Here\'s the part nobody tells you', "59% of mail-in contested parking tickets in Chicago get dismissed (FOIA, 2023–2025). The city knows most people won't bother fighting a $75 ticket. They're counting on you to just pay it."),
          ...
          callout('success', 'That\'s what Autopilot Protection does', "We monitor your plate, catch new tickets within days, and automatically mail a custom contest letter before the deadline. You don't lift a finger. <strong>59% of mail-contested tickets get dismissed.</strong>"),
    ...
    'foia-confirmation': {
      ...
      html: quickEmail({
        ...
        body: [
          ...
          button('Get Protected — $99/year', `${SITE}/get-started`, { color: '#10B981' }),
        ...
        html: quickEmail({
          ...
          body: [
            ...
            callout('danger', `You left up to $${potentialSavings.toLocaleString()} on the table`,
              `<strong>59% of mail-in contested parking tickets in Chicago get dismissed</strong> (FOIA, 2023–2025). That's not a guess — it's city data. If every one of your ${ticketCount} tickets had been automatically mail-contested, the historical dismissal rate suggests up to <strong>$${potentialSavings.toLocaleString()}</strong> could have stayed in your pocket instead of the city's.`),
            ...
            button('Start Autopilot Protection — $99/year', `${SITE}/get-started`, { color: '#10B981' }),
