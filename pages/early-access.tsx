    ...
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{ marginTop: '12px', color: '#A7F3D0' }}>68.5% of contested parking tickets win.</div>
        </div>
        <p style={{
          margin: '24px 0 0',
          color: '#64748B',
        ...
        <div style={{
          ...
          {[
            ...
            },
            {
              ...
              text: 'We generate and mail contest letters backed by FOIA data. 68.5% of contested parking tickets get dismissed.',
        ...
        <div style={{
          ...
          <div style={{
            ...
            {[
              ...
              { step: '4', title: 'You save money', desc: 'Track results and outcomes. 68.5% of contested parking tickets get dismissed.' },
            ].map((item, i) => (
              <div key={i}>
                <div style={{
                  width: '36px',
