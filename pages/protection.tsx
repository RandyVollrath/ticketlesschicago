          ...
          <div style={{
            ...
            {isWaitlistMode ? (
              ...
              <>
                ...
                {/* Only show Google sign-in option for users who aren't logged in */}
                {!user && (
                  <>
                    <div style={{ display: 'flex', alignItems: 'center', margin: '16px 0', gap: '12px' }}>
                      ...
                      <span style={{ color: COLORS.slate, fontSize: '14px', fontWeight: '500' }}>OR</span>
                      <div style={{ flex: 1, height: '1px', backgroundColor: COLORS.border }}></div>
                    </div>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: `2px solid ${COLORS.border}`,
                        borderRadius: '10px',
                        backgroundColor: googleAuthLoading ? COLORS.concrete : 'white',
                        color: COLORS.graphite,
                        fontSize: '16px',
                        fontWeight: '600',
                        cursor: (loading || googleAuthLoading) ? 'not-allowed' : 'pointer',
