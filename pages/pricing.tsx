  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F8FAFC', color: '#0F172A', fontFamily: 'Inter, -apple-system, sans-serif' }}>
      <main style={{ maxWidth: 960, margin: '0 auto', padding: '48px 20px' }}>
        ...
        <h1 style={{ fontSize: 42, margin: '16px 0 8px 0' }}>Autopilot Protection</h1>
        ...
        <section style={{ background: '#fff', border: '1px solid #E2E8F0', borderRadius: 16, padding: 24 }}>
          <p style={{ margin: 0, fontSize: 14, color: '#2563EB', fontWeight: 700, letterSpacing: '0.04em' }}>AUTOPILOT PROTECTION (ANNUAL)</p>
          <h2 style={{ fontSize: 44, margin: '8px 0 6px 0' }}>$99<span style={{ fontSize: 20, color: '#64748B' }}>/year</span></h2>
          <p style={{ margin: 0, color: '#64748B' }}>$99/year. Cancel anytime.</p>
          ...
          <ul style={{ marginTop: 16, color: '#334155', lineHeight: 1.8 }}>
            ...
            <li>City sticker &amp; plate auto-renewal — supervised rollout in 2026, we personally verify every renewal</li>
        ...
        <section style={{ marginTop: 20, background: '#fff', border: '1px solid #E2E8F0', borderRadius: 16, padding: 24 }}>
          <h3 style={{ marginTop: 0 }}>Auto-renewal Protection</h3>
          <p style={{ color: '#64748B', lineHeight: 1.7 }}>
            Your Autopilot membership includes city sticker and license plate auto-renewal.
            Auto-renewal is currently in supervised rollout — we personally verify every renewal in 2026
            so you can trust that your plates and stickers stay current without you thinking about it.
          </p>
