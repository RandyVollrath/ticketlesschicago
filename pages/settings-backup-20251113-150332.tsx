  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: 'white' }}>
      ...
      <main style={{ maxWidth: '1000px', margin: '0 auto', padding: '32px 24px' }}>
        ...
        {/* Document Status - Only for Protection users in permit zones */}
        {profile.has_permit_zone && profile.has_protection && user && (
          <DocumentStatus userId={user.id} hasPermitZone={true} />
        )}

        {/* Email Forwarding Setup - Only for Protection users in permit zones */}
        {profile.has_permit_zone && profile.has_protection && profile.email_forwarding_address && (
          <div style={{ marginTop: '32px' }}>
            <EmailForwardingSetup forwardingEmail={profile.email_forwarding_address} />
          </div>
        )}

        {/* License Access History - Only for Protection users in permit zones who uploaded license */}
        {profile.has_permit_zone && profile.has_protection && profile.license_image_path && user && (
          <div style={{ marginTop: '32px' }}>
        ...
        */}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          ...
          {/* Driver's License Upload - Only for Protection users in permit zones */}
