      ...
      <section style={{ maxWidth: '900px', margin: '0 auto', padding: '0 32px' }}>
            ...
            <div style={{ textAlign: 'center', padding: '20px 0' }}>
              ...
              <div style={{
                ...
                <p style={{ fontSize: '14px', color: '#15803D', lineHeight: 1.6, margin: '0 0 16px 0' }}>
                  Our Autopilot system detects new tickets and automatically contests them for you. 66% of contested parking tickets get dismissed.
                </p>
        ...
        <div style={{
          ...
          <p style={{
            ...
            66% of contested parking tickets get dismissed.
          </p>
