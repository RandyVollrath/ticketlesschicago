...
I respectfully request that this citation be dismissed.`,
    ...
    fallback: {
      ...
      template: `I contest citation #[TICKET_NUMBER] issued on [DATE] at [LOCATION] for an alleged no standing / time-restricted parking violation under Chicago Municipal Code § 9-64-140.

[USER_GROUNDS]

[SUPPORTING_INFO]

1. PROOF OF POSTED RESTRICTION. Establishing this violation requires that the restriction was lawfully posted at the cited location and in effect at the moment of citation. I request the following records: (a) the City's record of the posted restriction (type, hours, exemptions) for the cited block, and (b) the most recent sign maintenance / replacement record for restriction signs within 100 feet of the cited location.

2. PROOF OF NOTICE. Chicago Municipal Code § 9-100-050 requires that parking violations be properly documented at the time of issuance. I request the issuing officer's contemporaneous field notes, the handheld citation device data with GPS coordinates and timestamp, and any photographs taken by the issuing officer at the time of citation showing the vehicle's position relative to the posted signs.

3. LOADING / UNLOADING EXCEPTION. A vehicle briefly stopped to expeditiously load or unload passengers or property is generally permitted under 625 ILCS 5/11-1305 even in many "No Standing" zones. If applicable, I assert this defense.
...
If the City cannot establish that the restriction was lawfully posted, in effect at the moment of citation, and violated by the cited vehicle, dismissal is the appropriate remedy.`,
