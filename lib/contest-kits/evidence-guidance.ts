...
export const EVIDENCE_GUIDANCE: Record<string, EvidenceGuidance> = {
  ...
  no_city_sticker: {
    ...
    emailSubject: 'City Sticker Ticket ($200!) - 70% Win Rate - Buy Your Sticker NOW to Beat This!',
    title: 'Your $200 City Sticker Ticket Has Excellent Odds!',
    winRate: 0.70,
    intro: `City sticker tickets have a 70% success rate when contested! Here's the key: even if you didn't have a sticker when you got the ticket, you can purchase one NOW and use the receipt to get the ticket dismissed. The city routinely dismisses these when you show proof of purchase — even if you bought it after the ticket. This saves you $200! Buy your sticker right now and send us the receipt.`,
    questions: [
      {
        text: '🚨 MOST IMPORTANT: Buy your city sticker RIGHT NOW if you haven\'t already! Go to https://www.chicago.gov/city/en/depts/fin/supp_info/revenue/city_sticker.html and purchase it online. Then forward the confirmation email/receipt to us. This is the #1 way to beat this ticket — even buying AFTER the ticket date works!',
        whyItMatters: 'Proof of purchase (even after the ticket!) is the strongest defense. The city dismisses most city sticker tickets when the owner shows they bought a sticker. You save $200 by spending ~$90 on the sticker.',
        impactScore: 0.50,
        goodExample: 'Forward the email from City of Chicago showing "Vehicle Sticker Purchase Confirmation" with the date and amount',
      },
      {
        text: 'If you already had a sticker when you got this ticket, please send a screenshot of your purchase confirmation email, online receipt, or credit card statement showing the purchase date was BEFORE the ticket.',
        whyItMatters: 'If you already had one, proving the purchase date was before the ticket is an even stronger defense.',
        impactScore: 0.45,
        goodExample: 'Email showing "City of Chicago Vehicle Sticker Purchase - Confirmation #12345 - December 15, 2024"',
      },
      {
        text: 'Do you live outside Chicago? Are you registered at an address outside city limits?',
        whyItMatters: 'Non-residents are exempt from the city sticker requirement. If you don\'t live in Chicago, this ticket should be dismissed without needing to buy a sticker.',
        impactScore: 0.40,
      ...
      },
      {
        ...
        whyItMatters: 'New vehicle owners have a 30-day grace period to purchase a city sticker.',
        impactScore: 0.30,
        goodExample: '"I bought the car on January 1st, ticket was January 15th - I was within the 30-day window"',
      },
    ],
    quickTips: [
      'BUY YOUR STICKER NOW at chicago.gov/sticker — even buying AFTER the ticket works to get it dismissed!',
      'The sticker costs ~$90 but the ticket is $200 — buying it saves you $110+ AND beats the ticket',
      'Forward your purchase confirmation email to us — that\'s all the evidence we need',
      ...
      'Non-Chicago residents are EXEMPT — you don\'t need to buy one, just prove you live elsewhere',
    ],
    pitfalls: [
      'Don\'t ignore this ticket! At $200 it\'s one of the most expensive parking tickets',
      'Don\'t pay the ticket without trying to contest — the win rate is 70%!',
    ],
    weatherRelevant: false,
  },
