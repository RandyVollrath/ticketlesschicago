...
export const EVIDENCE_GUIDANCE: Record<string, EvidenceGuidance> = {
  ...
  no_city_sticker: {
    ...
    winRate: 0.70,
    intro: `City sticker tickets have a 70% success rate! The most common winning defense is proving you purchased the sticker before the ticket, or that you're not required to have one (non-Chicago resident, new vehicle, etc.).`,
    questions: [
      {
        text: 'Did you purchase your city sticker BEFORE the ticket date? Please send a screenshot of your purchase confirmation email, online receipt, or credit card statement showing the purchase.',
        whyItMatters: 'Proof of prior purchase is the strongest defense - showing you bought it before the ticket typically results in dismissal.',
        impactScore: 0.45,
        goodExample: 'Email showing "City of Chicago Vehicle Sticker Purchase - Confirmation #12345 - December 15, 2024"',
      },
      {
        text: 'Are you registered outside Chicago city limits? Is this your first time being ticketed in Chicago?',
        whyItMatters: 'Non-residents and visitors are exempt from the city sticker requirement. If you don\'t live in Chicago, this ticket should be dismissed.',
        impactScore: 0.40,
        goodExample: '"I live in Evanston and was just visiting downtown Chicago for the day. My vehicle is registered to my Evanston address."',
      },
      {
      ...
      {
        text: 'Was your sticker purchased but just not yet displayed on your windshield? Why?',
        whyItMatters: 'If you purchased but hadn\'t applied it yet, we need to explain the circumstances.',
        impactScore: 0.20,
      },
    ],
    quickTips: [
    ...
    pitfalls: [
      'Don\'t claim you bought it if you didn\'t',
      'Don\'t assume your sticker is on the car - check your windshield',
    ],
    weatherRelevant: false,
  },
