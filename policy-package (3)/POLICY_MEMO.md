...
**Source:** City of Chicago FOIA response, Department of Administrative Hearings, parking and automated-camera disposition records, 1/10/2019 through 9/9/2025. **1,198,179 hearings, 74 hearing officers.** Released in response to Illinois FOIA request **H118909-110325** ("All hearing outcomes parking / traffic / camera 2019-present").

---

## Citywide baseline — pick the right denominator

These three rates all come out of the same 1.2M-row file and they all matter for different reasons:

| Slice | Hearings | Liable | Not Liable |
|---|---:|---:|---:|
| **Everything** (all methods, parking + cameras) | 1,198,179 | 44.0% | 53.8% |
| **Parking tickets only** (red light + speed cameras excluded) | 972,638 | 36.3% | 61.9% |
| **Parking tickets, in-person hearings only** | 249,845 | 26.3% | **66.8%** |
| **Parking tickets, virtual hearings** | 44,451 | 24.5% | 75.5% |

The "majority of contests win" framing usually refers to **parking-ticket hearings on the merits**, where motorists win roughly **two out of three cases**. The full-population 44% liable rate is dragged up by red-light and speed-camera cases (~277,000 of the 1.2M), which are 80%+ liable because the only winning defenses (stolen vehicle, factually inconsistent photo) rarely apply.

For the disparity-by-officer findings below, the figures are reported on the **full population** unless otherwise noted. The patterns hold on every subset.

---

## The headline finding

**The single biggest predictor of whether a contested ticket is found "Liable" is which hearing officer is assigned to the case** — not the violation, not the contest method, not the evidence.
