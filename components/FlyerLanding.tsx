      ...
      <div style={{
        ...
        <main style={{ maxWidth: 640, margin: '0 auto', padding: '32px 20px 64px' }}>
          ...
          <Card>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <Fact
                ...
                body="A ticket lawyer charges $150–$300 to draft one letter. The average Chicago driver has 2.2 tickets/year. At $79/year unlimited, the Chicago Ticket Defense Plan is 4–8× cheaper than hiring it out once."
              />
            </div>
          </Card>
          ...
          <Link href="/get-started" style={{
            ...
            Start the Chicago Ticket Defense Plan → $79/yr
          </Link>
