              ...
              <div className={styles.parkHereZones}>
                {alternativeSections.map((zone, index) => (
                  <div key={`${zone.ward}-${zone.section}`} className={styles.zoneCard}>
                    ...
                    {zone.distance_miles !== undefined && zone.compass_direction && (
                      <div className={styles.directions} style={{
                        ...
                        <div style={{
                          ...
                          🚗 <span style={{ textTransform: 'capitalize' }}>{zone.distance_miles.toFixed(1)} miles {zone.compass_direction}</span> of your address
                        </div>
                      </div>
                    )}
