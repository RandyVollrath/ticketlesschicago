...
async function fix() {
  ...
  const userId = '4973c19d-348c-4cfc-96d4-e27d6912a2e0';
  ...
  await resend.emails.send({
    ...
    html: '<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;"><h2>Welcome to Ticket Protection!</h2><p>Click below to access your account:</p><div style="margin: 32px 0; text-align: center;"><a href="' + linkData.properties.action_link + '" style="background-color: #0052cc; color: white; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; display: inline-block;">Access My Account</a></div><p><strong>Important:</strong> Complete your profile to activate your $200/year ticket guarantee.</p></div>'
  });
